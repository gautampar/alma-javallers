...
export default function Alma1Slider() {
    ...
    const cards = [
        { id: 1, img: "/assets/shop/img1.png" },
        { id: 2, img: "/assets/shop/img1.png" },
        { id: 3, img: "/assets/shop/img1.png" },
        { id: 4, img: "/assets/shop/img1.png" },
        { id: 5, img: "/assets/shop/img1.png" },
        { id: 6, img: "/assets/shop/img1.png" },
        { id: 7, img: "/assets/shop/img1.png" },
        { id: 8, img: "/assets/shop/img1.png" },
    ];
